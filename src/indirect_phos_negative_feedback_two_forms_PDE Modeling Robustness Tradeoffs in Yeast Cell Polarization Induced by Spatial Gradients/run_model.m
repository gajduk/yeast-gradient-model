function [r,t,sol,u,steady_state,half_fraction] = run_model(time_steps,end_time,spatial_steps,R,D,p0,ka,kp,A,phos0,phos_max,phos_regulation_rate)
    ...
    m = 2;
    pdefun = @(x,t,u,DuDx) pdex1pde(x,t,u,DuDx,D,kp,ka,R,A,phos_max,phos_regulation_rate,phos0);%actual PDE
    icfun = @(x) pdex1ic(x,p0,phos0);%initial conditions
