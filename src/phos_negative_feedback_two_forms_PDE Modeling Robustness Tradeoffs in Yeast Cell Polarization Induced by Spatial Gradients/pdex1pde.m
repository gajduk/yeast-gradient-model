function [c,f,s] = pdex1pde(x,t,u,DuDx,D,kp,ka,R,k_cat,E0,K_M,A)
...
pr = phosphatase_rate(pa,k_cat,E0,K_M,A);%the activity of the phosphotases is proportionally to pa
...
c = [1; 1];
f = [D; D].*DuDx;
s = [2*D/x; 2*D/x].*DuDx+[pr-ea*p;-pr+ea*p];
